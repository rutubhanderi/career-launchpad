    ...
    <footer className="bg-gray-900/50">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white">Skill Building</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white">Find Opportunities</Link></li>
              <li><Link href="/interview-prep" className="text-gray-400 hover:text-white">Interview Prep</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-bold text-lg text-white mb-4">Follow Us</h3>
            <p className="text-gray-400 mb-4">Stay connected for the latest career tips and job opportunities.</p>
        ...
        <div className="mt-12 border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500">&copy; {new Date().getFullYear()} Career Launchpad. All rights reserved.</p>
