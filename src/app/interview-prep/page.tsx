...
const resources: Resource[] = [
  { badge: "Speaking", title: "Toastmasters Resources", href: "https://www.toastmasters.org/resources" },
  { badge: "English", title: "BBC Learning English", href: "https://www.bbc.co.uk/learningenglish" },
  { badge: "Resume", title: "Resume Worded Checker", href: "https://resumeworded.com/resume-checker" },
  ...
  { badge: "Interview Patterns", title: "Glassdoor Reviews", href: "https://www.glassdoor.co.in/Interview/index.htm" },
  { badge: "HR Questions", title: "InterviewBit HR Guide", href: "https://www.interviewbit.com/hr-interview-questions/" },
  { badge: "Templates", title: "Overleaf Resume Templates", href: "https://www.overleaf.com/gallery/tagged/cv" },
  { badge: "Public Speaking", title: "Coursera: Public Speaking", href: "https://www.coursera.org/learn/public-speaking" },
];
...
const topTips = [
  ...
  "If you don't know something, say so and think out loud — honesty wins.",
  "Follow up with a thank-you email within 24 hours.",
];

// ─── Prep Format Cards (with links) ──────────────────────────────────────────
    ...
    <>
      ...
      <div className="bg-gray-900 py-5 px-6">
        <div className="container mx-auto flex items-center justify-center gap-3 flex-wrap text-sm font-semibold text-brand-teal">
          {["Speak clearly", "Know your resume", "Explain well", "Handle questions smartly"].map(
            (t, i, arr) => (
      ...
      <section className="py-24 scroll-mt-16" id="questions">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Click to reveal peer-tested strategies for each question</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  { icon: <FaRegComments size={15} />, text: "Listen actively and pause before answering." },
                  { icon: <FaCheckSquare size={15} />, text: "Keep answers concise — aim for 1–2 minutes per response unless asked for more detail." },
                  { icon: <FaRegFileAlt size={15} />, text: "Ask thoughtful questions at the end — it signals genuine interest." },
                  { icon: <FaUsersCog size={15} />, text: "If you don't know something, say so and think out loud — honesty wins." },
                  { icon: <FaArrowRight size={15} />, text: "Follow up with a thank-you email within 24 hours." },
                ].map((tip, i) => (
                  <li key={i} className="flex items-start gap-4 bg-lime-400/5 border border-lime-400/10 hover:border-lime-400/25 transition-colors rounded-xl px-5 py-4">
