...
const teamMembers = [
  {
    name: "Priya Sharma",
    role: "Founder & CEO",
    bio: "Former Google exec with 12+ years of experience in tech hiring and talent development.",
    initials: "PS",
  },
  {
    name: "Marcus Chen",
    role: "Head of Curriculum",
    bio: "Ex-McKinsey consultant specializing in career coaching and organizational development.",
    initials: "MC",
  },
  {
    name: "Aisha Okonkwo",
    role: "Lead Interview Coach",
    bio: "Veteran recruiter from both Amazon and Meta, helping 500+ candidates land top roles.",
    initials: "AO",
  },
];
      ...
      <section className="bg-brand-blue py-20 text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-4 text-lg md:text-xl text-blue-200 max-w-3xl mx-auto">
            We're on a mission to democratize career success — empowering every
            student to prepare, apply, and thrive.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6 text-lg">
              To provide every job seeker with a clear, structured, and
              actionable path to a great career, regardless of their background.
              We remove the guesswork from career growth.
            </p>
            <h2 className="text-3xl font-bold text-brand-teal mb-4">Our Vision</h2>
            <p className="text-gray-300 text-lg">
              A world where talent — not connections — determines career success.
              We envision a future where every aspiring professional has access
              to the tools, knowledge, and opportunities needed to reach their
              full potential.
            </p>
          </div>
        </div>
          ...
          <div className="mt-12 grid md:grid-cols-4 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                We believe world-class career guidance should be available to
                everyone.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                We cut the noise to provide precise and clear, actionable advice.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                We are committed to your continuous growth — technically,
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                We foster a supportive community where learners uplift one
                another.
              </p>
            </div>
          </div>
